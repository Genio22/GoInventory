...
=======
    ...
    private TextField weight_textField;
                                                    ...
                                                    // For Deliverd Table
@FXML private TableView<Order> Oreder_Table1;
@FXML private TableColumn<Order, Integer> invoice_idfx1;
@FXML private TableColumn<Order, String> customer_name1;
@FXML private TableColumn<Order, String> phone_number1;
@FXML private TableColumn<Order, String> address1;
@FXML private TableColumn<Order, String> district1;
@FXML private TableColumn<Order, String> note1;
@FXML private TableColumn<Order, Double> amount1;
@FXML private TableColumn<Order, Double> weight1;
@FXML private TableColumn<Order, String> date1;

                                                        // For Pending Table
@FXML private TableView<Order> Order_Table2; 
@FXML private TableColumn<Order, Integer> invoice_idfx2;
@FXML private TableColumn<Order, String> customer_name2;
@FXML private TableColumn<Order, String> phone_number2;
@FXML private TableColumn<Order, String> address2;
@FXML private TableColumn<Order, String> district2;
@FXML private TableColumn<Order, String> note2;
@FXML private TableColumn<Order, Double> amount2;
@FXML private TableColumn<Order, Double> weight2;
@FXML private TableColumn<Order, String> date2;
